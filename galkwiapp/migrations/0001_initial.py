# -*- coding: utf-8 -*-
# Generated by Django 1.10.5 on 2017-01-26 15:09
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('status', models.CharField(choices=[('DRAFT', '편집 중'), ('VOTING', '투표 중'), ('CANCELED', '취소'), ('APPROVED', '허용'), ('REJECTED', '거절'), ('EXPIRED', '만료')], max_length=10)),
                ...
                ('entry', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='galkwiapp.Entry')),
                ('parent', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='galkwiapp.Revision')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('description', models.CharField(blank=True, max_length=1000, verbose_name='부가 설명')),
            ],
        ),
        migrations.AddField(
            model_name='revision',
            name='word',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='galkwiapp.Word'),
        ),
        migrations.AddField(
            model_name='entry',
            name='latest',
