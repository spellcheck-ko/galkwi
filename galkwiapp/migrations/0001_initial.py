# -*- coding: utf-8 -*-
# Generated by Django 1.10.4 on 2017-01-27 10:25
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tos_rev', models.DateTimeField(blank=True, null=True, verbose_name='약관 동의')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('status', models.CharField(choices=[('DRAFT', '편집 중'), ('VOTING', '투표 중'), ('CANCELED', '취소'), ('APPROVED', '허용'), ('REJECTED', '거절'), ('EXPIRED', '만료')], max_length=10, verbose_name='상태')),
                ...
                ('entry', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='galkwiapp.Entry', verbose_name='단어 항목')),
